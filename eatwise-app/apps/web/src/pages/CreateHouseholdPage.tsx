  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-lg bg-white border border-gray-200 rounded-lg shadow-sm p-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-4">Create Household</h1>

        {!inviteCode ? (
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700" htmlFor="householdName">
                Household Name
              </label>
              <input
                id="householdName"
          ...
          <div className="space-y-4">
            <p className="text-green-700 font-medium">Household "{createdHousehold}" created!</p>
            <p className="text-sm text-gray-600">Share this invite code with family members:</p>
